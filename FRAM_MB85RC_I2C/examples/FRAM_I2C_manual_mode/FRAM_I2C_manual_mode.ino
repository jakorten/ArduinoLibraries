...
/*!
    ...
    // Below this line was in the original but is piece of cake for any Embedded Systems Engineering student
    // that passed their first year ;) JK.
...
int pin = 13;
uint16_t chipDensity = chip_density::MB85RC1MT; //Just change that value to the density you want : 4, 16, 64, 128, 256, 512 or 1024
// For a 1Mbit chip this should be 1024
...
FRAM_MB85RC_I2C mymemory(&Wire2, chipaddress, wp, pin, chipDensity);
